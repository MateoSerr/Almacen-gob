...
<div class="px-4 sm:px-0">
    ...
    <div class="flex justify-between items-center mb-6 no-print">
        <h1 class="text-3xl font-bold text-gray-900">Detalle de Salida</h1>
        <div class="space-x-2">
            <a href="{{ route('salidas.descargar-word', ['salida' => $salida->id]) }}" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">
                📄 Descargar Word
            </a>
            <button onclick="window.print()" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                🖨️ Imprimir
            </button>
            <a href="{{ route('salidas.edit', ['salida' => $salida->id]) }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                ✏️ Editar
            </a>
            <a href="{{ route('salidas.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded">
                Volver
            </a>
        </div>
    </div>

    <!-- Formato oficial para impresión - EXACTAMENTE COMO ESTABA -->
        ...
        <table class="info-table">
            ...
            <tr>
                <td>
                    ...
                    {{ $salida->destino ?: 'Oficina del Fiscal' }}
                </td>
        ...
        <table class="signatures">
            <tr>
                <td class="signature-cell">
                    ...
                    <div class="signature-name">{{ $salida->entrega_nombre ?? '' }}</div>
                </td>

                <td class="signature-cell">
                    <div class="signature-label">Recibió</div>
                    <div class="signature-line"></div>
                    <div class="signature-name">{{ $salida->recibe_nombre ?? '' }}</div>
                </td>
            </tr>
        </table>
    </div>
