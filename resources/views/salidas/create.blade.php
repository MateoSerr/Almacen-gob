...
<div class="px-4 sm:px-0">
    <h1 class="text-3xl font-bold text-gray-900 mb-6">Registrar Nueva Salida</h1>

    <div class="bg-white shadow sm:rounded-lg">
        <form method="POST" action="{{ route('salidas.store') }}" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="motivo" id="motivo" value="{{ old('motivo') }}" placeholder="Ej: Uso interno, Venta, Dañado, etc."
                        class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
